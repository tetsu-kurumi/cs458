...
#         print(f"Combinations of numbers that sum up to {target_sum} (using each number at most once, treating sorted combinations as the same):")
    ...
    #             if playerhand.get_value() != i:
    #                 tracker += 13
    #                 odd_values.append(playerhand.get_value())
    #                 break
    ...
    #             # print("Player's hand value:", playerhand.get_value())
    ...
    #         while playerhand.get_value() < 17:
        #         playerhand_simulation.append(random.choice(['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A']))

        #     # Dealer's turn
        #     while sum(dealerhand_simulation) < 17:
        #         dealerhand_simulation.append(random.choice(['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A']))

        #     # Determine the winner
        #     player_sum = sum(playerhand_simulation)
        #     dealer_sum = sum(dealerhand_simulation)
        ...
        # playerhand.add_card(card)
        # dealerhand.add_card(my_deck.deal_card())
        # playerhand.add_card(my_deck.deal_card())
        # dealerhand.add_card(my_deck.deal_card())
        ...
        # print("Player's final hand:", playerhand, "Value:", playerhand.get_value())
        # print("Dealer's final hand:", dealerhand, "Value:", dealerhand.get_value())
        ...
        # dealerhand.add_card(cards[-1])


        # # Initialize deck and remove cards that are already dealt
        # deck = Deck()
        # cards_to_remove = []
        # cards_to_remove.append(dealerhand)
        # cards_to_remove.append(playerhand)
